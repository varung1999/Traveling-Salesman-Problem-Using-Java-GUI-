 ...
 * @since 2021-10-02
 */
public class TSP implements AlgoritmsInterface {
    private int cityNum;
    ...
    public ArrayList<ArrayList<Route>> algorithmInterface(List<City> cityList) {
        ...
        ArrayList<ArrayList<Route>> routeList = new ArrayList<>();
        int i = 0;
        while (rowFlag[i] == 1) {
	...
	/**
	 * 
	 * Caluclating the didstance matrix
	 *
	 */
	...
	/**
	 * 
	 * Getting the nearest city index
	 *
	 */
	...
	/**
	 * 
	 * Caluclating the Euclidean Distance
	 *
	 */
